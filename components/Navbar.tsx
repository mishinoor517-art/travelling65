      ...
      >
        ...
        <nav className="flex items-center justify-between px-5 md:px-7 py-3">
          ...
          >
            ...
            <span className="relative h-16 w-16 md:h-20 md:w-20 rounded-xl overflow-hidden bg-white shadow-md shadow-black/10 p-1 group-hover:scale-105 transition-transform duration-500 shrink-0">
              ...
              <li key={l.href}>
                ...
                <a
                  ...
                  className={`text-sm font-medium tracking-wide transition-colors relative group ${
                    scrolled
                      ? "text-ink/80 dark:text-white/80 hover:text-primary-600"
          ...
          <div className="hidden lg:flex items-center gap-3">
            ...
            <button
              ...
              className={`grid place-items-center w-9 h-9 rounded-full transition-colors ${
                scrolled
                  ? "text-ink dark:text-white hover:bg-primary-50 dark:hover:bg-white/10"
