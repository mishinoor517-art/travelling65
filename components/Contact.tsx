            ...
            <div className="rounded-3xl bg-white dark:bg-white/5 border border-black/5 dark:border-white/10 shadow-lg shadow-black/5 p-8">
              ...
              >
                ...
                <div className="flex flex-col gap-1.5">
                  <label className="text-xs font-medium text-ink/60 dark:text-white/60">
                    Name
                  </label>

                  <input
                    required
                    className="rounded-xl border border-black/10 dark:border-white/15 bg-transparent px-4 py-3 text-sm outline-none focus:border-primary-600 transition-colors dark:text-white"
                ...
                <div className="sm:col-span-2 flex flex-col gap-1.5">
                  ...
                  <textarea
                    rows={4}
                    required
                    className="rounded-xl border border-black/10 dark:border-white/15 bg-transparent px-4 py-3 text-sm outline-none focus:border-primary-600 transition-colors dark:text-white resize-none"
          ...
          >
            ...
            <div className="rounded-3xl overflow-hidden h-48 relative">
              <iframe
                ...
                loading="lazy"
                src="https://www.google.com/maps?q=32.0631373,72.6936786&z=17&output=embed"
                allowFullScreen
              />
            </div>
            ...
            <div className="rounded-3xl bg-ink dark:bg-white/5 p-7 text-white space-y-5 flex-1">
              ...
              <div className="flex items-start gap-3">
                ...
                <p className="text-sm text-white/80">
                  Office #40, 4th Floor, Mall of Sargodha, Sargodha, Pakistan
                </p>
              </div>
